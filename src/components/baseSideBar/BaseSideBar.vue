<template>
  <div>
    ...
    <div :class="{ 'd-flex': isDisplay, 'd-none': !isDisplay, 'max-w-md': width === 'max-w-md', 'max-w-2xl': width === 'max-w-2xl', 'max-w-xl': width === 'max-w-xl'  }" class="bg-white fixed flex-col top-0 right-0 h-full z-50 xs:w-11/12 sm:w-11/12 md:w-100">
