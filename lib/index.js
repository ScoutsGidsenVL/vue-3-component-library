...
const _hoisted_2$7 = { class: "btn-simple-dark  mt-0 relative" };
const _hoisted_3$6 = { class: "absolute flex justify-center items-center w-full left-0 top-0 h-full" };
vue.popScopeId();
...
vue.pushScopeId("data-v-c69e8e72");
