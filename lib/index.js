...
const _hoisted_2$2 = /*#__PURE__*/vue.createVNode("h1", null, "test123", -1 /* HOISTED */);
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return (_ctx.rules.includes('required') || _ctx.rules.includes('customRequired'))
    ? (vue.openBlock(), vue.createBlock("label", _hoisted_1$2, "*"))
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createBlock("div", null, [
    (!_ctx.hideInput && _ctx.label)
      ? (vue.openBlock(), vue.createBlock("strong", _hoisted_1$1, [
...
exports.CustomInput = script$2;
exports.HelloWorld = script$4;
exports.PageTitle = script;
