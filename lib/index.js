...
const normalizeRef = ({ ref }) => {
    return (ref != null
        ? isString(ref) || reactivity.isRef(ref) || isFunction(ref)
...
const _hoisted_2$1 = /*#__PURE__*/createVNode("h1", null, "test12", -1 /* HOISTED */);
...
script$2.__file = "src/components/helloWorld/HelloWorld.vue";
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", null, [
    _hoisted_1$1,
    createVNode("h1", null, toDisplayString(_ctx.name), 1 /* TEXT */)
  ]))
}
...
function useValidationState({ name, initValue, form, type, checkedValue, standalone, }) {
    ...
    function resetValidationState(state) {
        ...
        const newValue = state && 'value' in state
            ? state.value
            : getFromPath(reactivity.unref(formInitialValues), fieldPath, reactivity.unref(initValue));
        if (form) {
...
function useForm(opts) {
    ...
    function unregisterField(field) {
        ...
        const valueIdx = (_b = (_a = getFromPath(formValues, fieldName)) === null || _a === void 0 ? void 0 : _a.indexOf) === null || _b === void 0 ? void 0 : _b.call(_a, reactivity.unref(field.checkedValue));
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", null, [
    (!_ctx.hideInput && _ctx.label)
      ? (openBlock(), createBlock("strong", _hoisted_1, [
          createVNode("p", null, toDisplayString(_ctx.label), 1 /* TEXT */)
        ]))
