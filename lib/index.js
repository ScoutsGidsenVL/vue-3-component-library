...
const _hoisted_1$6 = /*#__PURE__*/vue.createElementVNode("path", { d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" }, null, -1 /* HOISTED */);
const _hoisted_2$5 = [
  _hoisted_1$6
];
...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.withDirectives((vue.openBlock(), vue.createElementBlock("svg", {
    ...
    viewBox: "0 0 24 24"
  }, _hoisted_2$5, 2 /* CLASS */)), [
    [vue.vShow, _ctx.isLoading]
  ])
}

script$7.render = render$7;
script$7.__file = "src/components/loader/Loader.vue";
...
const _hoisted_2$4 = { class: "btn-simple-dark  mt-0 relative" };
const _hoisted_3$4 = { class: "absolute flex justify-center items-center w-full left-0 top-0 h-full" };
vue.popScopeId();
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock("button", {
    ...
    vue.createElementVNode("a", _hoisted_2$4, [
...
script$6.__scopeId = "data-v-56556b4f";
script$6.__file = "src/components/customButton/CustomButton.vue";
...
const _hoisted_1$4 = { class: "px-4 pb-2 pt-3 custom-background" };
...
const _hoisted_5$3 = { class: "animate-none" };
const _hoisted_6$2 = {
  key: 0,
  action: ""
};
  ...
  return (vue.openBlock(), vue.createElementBlock("div", null, [
    ...
    vue.createElementVNode("div", {
      ...
      vue.createElementVNode("div", _hoisted_1$4, [
        ...
        vue.createElementVNode("h1", _hoisted_4$3, [
          vue.createElementVNode("span", _hoisted_5$3, vue.toDisplayString(_ctx.title), 1 /* TEXT */)
        ]),
...
script$5.__scopeId = "data-v-c69e8e72";
script$5.__file = "src/components/baseSideBar/BaseSideBar.vue";
...
const _hoisted_4 = { class: "sm:flex sm:items-start" };
...
exports.BaseSideBar = script$5;
exports.CustomButton = script$6;
exports.CustomInput = script$3;
exports.Loader = script$7;
