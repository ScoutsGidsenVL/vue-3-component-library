...
const _hoisted_1$1 = {
  key: 0,
  class: "h-full w-full fixed top-0 left-0 overflow-x-hidden bg-black bg-opacity-20 custom-index"
};
...
const _hoisted_7 = { class: "text-center sm:mt-0 sm:ml-4 sm:text-left" };
const _hoisted_8 = {
  class: "text-lg text-left leading-6 font-medium text-darkGray",
  id: "modal-title"
};
const _hoisted_9 = { class: "text-sm text-left text-darkGray" };
const _hoisted_10 = {
  key: 0,
            ...
            vue.createElementVNode("div", {
              ...
              vue.createElementVNode("div", _hoisted_4$1, [
                ...
                vue.createElementVNode("div", _hoisted_7, [
                  vue.createElementVNode("h3", _hoisted_8, vue.toDisplayString(_ctx.title), 1 /* TEXT */),
                  vue.createElementVNode("div", null, [
                    vue.createElementVNode("p", _hoisted_9, vue.toDisplayString(_ctx.text), 1 /* TEXT */)
                  ])
                ])
              ])
            ], 2 /* CLASS */),
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
    vue.createElementVNode("button", {
      ...
      "data-dismiss": "alert",
      "aria-label": "Close",
      onClick: _cache[0] || (_cache[0] = (...args) => (_ctx.hideToast && _ctx.hideToast(...args)))
    }, _hoisted_3),
    _hoisted_4,
