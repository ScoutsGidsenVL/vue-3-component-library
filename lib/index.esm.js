...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("div", null, [
    ...
    createElementVNode("div", {
      class: normalizeClass([{ 'd-flex': _ctx.isDisplay, 'd-none': !_ctx.isDisplay }, "bg-white fixed flex-col top-0 right-0 h-full z-20 xs:w-11/12 sm:w-11/12 md:w-100 max-w-md"])
    }, [
      createElementVNode("div", _hoisted_1$5, [
        ...
        (_ctx.options && !_ctx.isEdit)
          ? (openBlock(), createElementBlock("form", _hoisted_6$2, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.options, (option) => {
                  return (openBlock(), createElementBlock("div", { key: option }, [
                    ...
                    createElementVNode("label", {
                      ...
                      class: "ml-2"
                    }, toDisplayString(option.text), 9 /* TEXT, PROPS */, _hoisted_9$2)
                  ]))
                }), 128 /* KEYED_FRAGMENT */))
              ])
            ]))
...
export { script$1 as BasePage, script$6 as BaseSideBar, script$8 as CustomButton, script$7 as CustomHeader, script$3 as CustomInput, InputTypes, script$9 as Loader, script$2 as PageTitle, script$4 as Required, script$5 as SuccessToast, script as Warning, defineRules, scrollToFirstError, useFormSendWithSuccess, useScrollToTop };
