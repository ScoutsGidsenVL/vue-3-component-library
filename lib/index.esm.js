import { defineComponent, openBlock, createBlock, createVNode, unref, inject, computed, onMounted, provide, isRef, watch, onBeforeUnmount, ref, reactive, toRef, resolveDynamicComponent, h, getCurrentInstance, nextTick, warn, createCommentVNode, resolveComponent, createTextVNode, toDisplayString, renderSlot, withDirectives, vModelDynamic, vModelText, withCtx, vShow, pushScopeId, popScopeId, withScopeId } from 'vue';
...
const _hoisted_2$4 = /*#__PURE__*/createVNode("h1", null, "test123", -1 /* HOISTED */);
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  return (_ctx.rules.includes('required') || _ctx.rules.includes('customRequired'))
    ? (openBlock(), createBlock("label", _hoisted_1$4, "*"))
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", null, [
    (!_ctx.hideInput && _ctx.label)
      ? (openBlock(), createBlock("strong", _hoisted_1$3, [
          createVNode("p", null, [
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", null, [
    ...
    createVNode("h1", _hoisted_5, toDisplayString(_ctx.title), 1 /* TEXT */)
  ]))
}
...
const _hoisted_2$1 = /*#__PURE__*/createVNode("path", { d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" }, null, -1 /* HOISTED */);

function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives((openBlock(), createBlock("svg", _hoisted_1$1, [
    _hoisted_2$1
  ], 512 /* NEED_PATCH */)), [
...
const _withId = /*#__PURE__*/withScopeId("data-v-56556b4f");
...
export { script$3 as BasePage, script as CustomButton, script$4 as CustomInput, script$6 as HelloWorld, script$2 as PageTitle };
