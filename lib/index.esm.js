...
const _hoisted_2$1 = /*#__PURE__*/createVNode("h1", null, "test123", -1 /* HOISTED */);
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (_ctx.rules.includes('required') || _ctx.rules.includes('customRequired'))
    ? (openBlock(), createBlock("label", _hoisted_1$1, "*"))
    : createCommentVNode("v-if", true)
}

script$1.render = render$1;
script$1.__file = "src/components/required/Required.vue";
...
export { script as CustomInput, script$2 as HelloWorld };
