...
const _hoisted_2$2 = /*#__PURE__*/createElementVNode("path", { d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" }, null, -1 /* HOISTED */);
const _hoisted_3$2 = [
  _hoisted_2$2
];

function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return withDirectives((openBlock(), createElementBlock("svg", _hoisted_1$2, _hoisted_3$2, 512 /* NEED_PATCH */)), [
...
export { script$4 as BasePage, script as BaseSideBar, script$1 as CustomButton, script$5 as CustomInput, InputTypes, script$3 as PageTitle, defineRules, scrollToFirstError, useFormSendWithSuccess, useScrollToTop };
