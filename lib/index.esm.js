...
import { defineComponent, openBlock, createElementBlock, createCommentVNode, watch, resolveComponent, createElementVNode, createTextVNode, toDisplayString, createVNode, renderSlot, normalizeClass, withDirectives, vModelDynamic, vModelText, withCtx, vShow, pushScopeId, popScopeId, ref, toRefs, Fragment, renderList, vModelRadio } from 'vue';
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return (_ctx.rules.includes('required') || _ctx.rules.includes('customRequired'))
    ? (openBlock(), createElementBlock("label", _hoisted_1$5, "*"))
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", null, [
    (!_ctx.hideInput && _ctx.label)
      ? (openBlock(), createElementBlock("strong", _hoisted_1$4, [
...
const _hoisted_1$2 = /*#__PURE__*/createElementVNode("path", { d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" }, null, -1 /* HOISTED */);
const _hoisted_2$2 = [
  _hoisted_1$2
];
    ...
    createElementVNode("div", {
      ...
      createElementVNode("div", _hoisted_1, [
        ...
        createElementVNode("h1", _hoisted_4, [
          createElementVNode("span", _hoisted_5, toDisplayString(_ctx.title), 1 /* TEXT */)
        ]),
        (_ctx.options && !_ctx.isEdit)
          ? (openBlock(), createElementBlock("form", _hoisted_6, [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.options, (option) => {
                  return (openBlock(), createElementBlock("div", { key: option }, [
                    ...
                    createElementVNode("label", {
                      ...
                      class: "ml-2"
                    }, toDisplayString(option.text), 9 /* TEXT, PROPS */, _hoisted_9)
                  ]))
                }), 128 /* KEYED_FRAGMENT */))
              ])
            ]))
...
export { script$4 as BasePage, script as BaseSideBar, script$1 as CustomButton, script$5 as CustomInput, InputTypes, script$2 as Loader, script$3 as PageTitle, defineRules, scrollToFirstError, useFormSendWithSuccess, useScrollToTop };
