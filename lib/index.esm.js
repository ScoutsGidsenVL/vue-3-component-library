...
script$4.__file = "src/components/helloWorld/HelloWorld.vue";
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return (_ctx.rules.includes('required') || _ctx.rules.includes('customRequired'))
    ? (openBlock(), createBlock("label", _hoisted_1$2, "*"))
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", null, [
    (!_ctx.hideInput && _ctx.label)
      ? (openBlock(), createBlock("strong", _hoisted_1$1, [
          createVNode("p", null, [
...
script.__file = "src/components/pageTitle/PageTitle.vue";

export { script$1 as BasePage, script$2 as CustomInput, script$4 as HelloWorld, script as PageTitle };
